...
int main(void)
{
    ...
    // Run LRU benchmarks
    std::cout << "--------------- Starting SRRIP child processes -----------------" << std::endl;
    ...
    std::cout << "--------------- Finishing SRRIP child processes -----------------" << std::endl;
