...
int main(void)
{
    ...
    // Run LRU benchmarks
    std::cout << "--------------- Starting LFU child processes -----------------" << std::endl;
    ...
    std::cout << "--------------- Finishing LFU child processes -----------------" << std::endl;
